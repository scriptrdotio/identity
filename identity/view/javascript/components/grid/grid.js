...
angular
    ...
    'scriptrIdentityGrid',
    {
        ...
        controller : function($scope, $window, $uibModal, $timeout, identityForms, wsClient, dataStore, identityFactory, $routeParams,httpClient, $route, $timeout, $q, $loadingOverlay) {
