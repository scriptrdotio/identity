...
angular
    ...
    { 
        ...
        controller :  ['$location', '$scope', '$rootScope', 'httpClient', 'identityForms', '$routeParams', '$timeout', '$mdDialog', '$uibModal', '$route', '$loadingOverlay', 'identityFactory', function($location,$scope,$rootScope,httpClient, identityForms, $routeParams, $timeout, $mdDialog, $uibModal, $route, $loadingOverlay, identityFactory) {
         var self = this;
...
angular
    .module("Identity").controller('confirmDeleteDialogCtrl', ['httpClient', 'dataObject', 'grid', '$scope', 'parent', '$mdDialog', '$loadingOverlay', function(httpClient, dataObject, grid,$scope, parent, $mdDialog, $loadingOverlay) {
    var vm = this;
    vm.parent = parent;
...
angular
    .module("Identity").controller('viewIdentityDialogCtrl', ['$timeout', 'httpClient', 'identityData', 'grid', 'parent', '$mdDialog', '$scope', 'identityInfo', function($timeout, httpClient, identityData, grid, parent, $mdDialog, $scope, identityInfo) {
...
angular
    .module("Identity").controller('viewGroupDialogCtrl', ['$timeout', 'grid', 'httpClient', 'parent', 'groupData', '$mdDialog', '$scope', 'groupInfo', function($timeout, grid, httpClient, parent, groupData, $mdDialog, $scope, groupInfo) {
    var vm = this;
    /*vm.promptMessage = {
...
myApp
    ...
    .config(httpsConfig)
	.config(wssConfig)
    .config(['$routeProvider', 'routingJson', function($routeProvider, routingJson){
...
angular
    ...
    controller: ['$scope', 'httpClient', '$q', '$loadingOverlay', 'identityFactory', function ($scope, httpClient, $q, $loadingOverlay,identityFactory) {
        var self = this;
...
angular
    ...
    'scriptrIdentityGrid',
    {
        ...
        controller : ['$scope', '$window', '$uibModal', '$timeout', 'identityForms', 'wsClient', 'dataStore', 'identityFactory', '$routeParams', 'httpClient', '$route', '$timeout', '$q', '$loadingOverlay', function($scope, $window, $uibModal, $timeout, identityForms, wsClient, dataStore, identityFactory, $routeParams,httpClient, $route, $timeout, $q, $loadingOverlay) {
